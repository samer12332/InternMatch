...
export const CompanyStudentProfilePage = () => {
    ...
    useEffect(() => {
        if (!studentId || fetched.current) return;
    ...
    return (
        <>
            ...
            <main className="container py-5 company-page">
                <Link className="back-link mb-4" to="/company/students">
                ...
                {error ? (
                    ...
                    <article className="card student-profile-card overflow-hidden">
                        <div className="student-profile-banner">
                            <div className="student-avatar" aria-hidden="true">
                                {student.name.charAt(0).toUpperCase()}
                            </div>
                            <div>
                                <p className="text-white-50 text-uppercase fw-semibold small mb-1">
                                    Student profile
                                </p>
                                ...
                                <p className="text-white-50 mb-0">
                                    {student.major} · {student.city}
                                </p>
                            </div>
                        </div>
                        <div className="card-body p-4 p-md-5">
                            <div className="profile-stat-grid mb-5">
                                <div>
                                    <small>GPA</small>
                                    <strong>
                                        {student.gpa}
                            ...
                            <section>
                                ...
                                <h2 className="h4 mb-3">Profile summary</h2>
                                <p className="student-bio profile-bio mb-0">
                                    {student.bio ||
