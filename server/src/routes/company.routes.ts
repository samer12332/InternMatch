...
import { getStudentProfileHandler, searchStudentsHandler } from "../company/company-student.controller";
import {
  createInternshipSchema,
  internshipIdParamsSchema,
  updateInternshipSchema,
} from "../company/company-internship.schemas";
import { studentIdParamsSchema, studentSearchSchema } from "../company/company-student.schemas";
...
companyRouter.get("/students", validateQuery(studentSearchSchema), searchStudentsHandler);
companyRouter.get("/students/:studentId", validateParams(studentIdParamsSchema), getStudentProfileHandler);
